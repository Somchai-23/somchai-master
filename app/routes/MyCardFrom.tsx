    ...
    return(
        ...
        <form method="post" onSubmit={handleSubmit}>
            ...
            <p className="font-normal text-gray-700">
                สถานะนามบัตร
                <input type="checkbox" name="myStatus" defaultChecked = {true} className="border border-blue-300" 
                onChange={(e) => setMyStatus(e.target.checked)}
                />
            </p>
            <p className="font-normal text-gray-700">
                สาขาวิชา:<br/>
                <input type="radio" name = "myMajor"value="IT" onChange={(e) => setMyMajor(e.target.value)} />
                <label className="m-2">เทคโนโลยีสารสนเทศ</label><br/>
                <input type="radio" name = "myMajor"value="CS" onChange={(e) => setMyMajor(e.target.value)}/>
                <label className="m-2">วิทยาการคอมพิวเตอร์</label><br/>
                <input type="radio" name = "myMajor"value="DBI" onChange={(e) => setMyMajor(e.target.value)}/>
